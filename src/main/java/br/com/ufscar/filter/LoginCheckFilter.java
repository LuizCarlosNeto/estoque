...
public class LoginCheckFilter extends AbstractFilter implements Filter {
	...
	public void init(FilterConfig fConfig) throws ServletException {
		if(allowedURIs == null){
			...
			allowedURIs.add("/estoque/javax.faces.resource/main.css.xhtml");
			allowedURIs.add("/estoque/javax.faces.resource/theme.css.xhtml");
			allowedURIs.add("/estoque/javax.faces.resource/primefaces.js.xhtml");
